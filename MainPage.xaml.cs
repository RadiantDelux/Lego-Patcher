...
public partial class MainPage : ContentPage
{
    ...
    static readonly double[] ContourL = {
        0.227,0.438, 0.219,0.453, 0.216,0.469, 0.213,0.484, 0.209,0.500, 0.206,0.516,
        0.203,0.531, 0.199,0.547, 0.196,0.562, 0.193,0.578, 0.189,0.594, 0.187,0.609,
        0.183,0.625, 0.180,0.641, 0.177,0.656, 0.173,0.672, 0.170,0.688, 0.167,0.703,
        0.163,0.719, 0.160,0.734, 0.156,0.750, 0.153,0.766, 0.151,0.773, 0.187,0.773,
        0.463,0.766, 0.464,0.750, 0.464,0.734, 0.464,0.719, 0.465,0.703, 0.465,0.688,
        0.466,0.672, 0.466,0.656, 0.466,0.641, 0.467,0.625, 0.467,0.609, 0.326,0.594,
        0.326,0.578, 0.327,0.562, 0.329,0.547, 0.331,0.531, 0.333,0.516, 0.334,0.500,
        0.336,0.484, 0.338,0.469, 0.339,0.453, 0.339,0.438 };
    static readonly double[] ContourR = {
        0.669,0.435, 0.666,0.451, 0.668,0.466, 0.670,0.482, 0.672,0.497, 0.673,0.513,
        0.676,0.529, 0.677,0.544, 0.679,0.560, 0.681,0.576, 0.681,0.591, 0.542,0.607,
        0.542,0.622, 0.542,0.638, 0.543,0.654, 0.544,0.669, 0.544,0.685, 0.545,0.701,
        0.546,0.716, 0.546,0.732, 0.547,0.747, 0.548,0.763, 0.549,0.771, 0.563,0.771,
        0.858,0.763, 0.854,0.747, 0.852,0.732, 0.848,0.716, 0.844,0.701, 0.841,0.685,
        0.837,0.669, 0.833,0.654, 0.830,0.638, 0.826,0.622, 0.823,0.607, 0.819,0.591,
        0.815,0.576, 0.812,0.560, 0.809,0.544, 0.805,0.529, 0.802,0.513, 0.798,0.497,
        0.794,0.482, 0.790,0.466, 0.787,0.451, 0.780,0.435 };
    ...
    {
        if (!_slotViews.TryGetValue(id, out var b)) return;
        // Side figure slots (L1-L3, R1-R3) no longer light up individually; the
        // LED color is shown only by the panel-fill polygons (_glowL/_glowR).
        // The center has no fill polygon, so its circular slot still glows.
        if (id != "C") { AnimateSlotGlow(b, Colors.Transparent); return; }
